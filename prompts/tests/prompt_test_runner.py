...
class PromptTestRunner:
    ...
    def extract_sql_from_response(self, agent_state: Dict) -> Optional[str]:
        ...
        """
        # This is simplified - in reality we'd need to hook into the agent's
        # internal state to capture the SQL it generates
        # For now, we'll look for SQL patterns in the response
