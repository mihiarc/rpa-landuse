#!/usr/bin/env python3
"""
Prompt Version 1.1.0 - Add Off-Topic Query Rejection
Released: 2025-09-29
Author: System
Status: Production

New Feature: Added domain scope limitation instructions to reject off-topic queries
and maintain focus on land use/RPA Assessment expertise. Agent now politely
declines questions unrelated to its core purpose.
"""
...
AUTHOR = "System"
STATUS = "production"
DESCRIPTION = "Added off-topic query rejection instructions to maintain domain focus"
