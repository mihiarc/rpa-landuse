#!/usr/bin/env python3
"""
Prompt Version 1.0.1 - Bug Fix for Column Names
Released: 2025-09-28
Author: System
Status: Production

Bug fix: Corrected SQL examples to use proper column names (to_landuse_id instead of to_landuse)
and updated table references to match actual database schema.
"""
...
AUTHOR = "System"
STATUS = "production"
DESCRIPTION = "Bug fix: Corrected SQL examples to use proper column names and table references"
