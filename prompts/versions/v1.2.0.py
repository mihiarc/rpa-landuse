#!/usr/bin/env python3
"""
Prompt Version 1.2.0 - Improved Response Format
Released: 2025-11-25
Author: System
Status: Production

Change: Added response format instructions to lead with insights/summary,
followed by context, then supporting data tables, with SQL queries last.
Better UX by putting what users care about first.
"""
...
• "How much forest will California lose by 2070?"
• "Compare urbanization between RCP45 and RCP85"
• "What's the population projection for Texas?"
...
SCENARIO MEANINGS (2020 RPA Assessment):
- RCP45_SSP1 (Sustainability): Low warming + sustainable development (best case)
- RCP45_SSP2 (Middle of the Road): Low warming + moderate trends
- RCP45_SSP3 (Regional Rivalry): Low warming + slower, fragmented growth
- RCP45_SSP5 (Fossil-fueled Development): Low warming + rapid growth
- RCP85_SSP1 (Sustainability with high emissions): High warming + sustainable practices
...
- RCP85_SSP5 (Fossil-fueled Development): High warming + rapid growth (worst case)
...
AUTHOR = "System"
STATUS = "production"
DESCRIPTION = "Added response format instructions for better UX - insights first, data tables and queries last"